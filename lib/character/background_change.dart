                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => MainScreen(characterImage: 'assets/background/background1.jpg'),
                          ),
                        );
                      },
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => MainScreen(characterImage: 'assets/background/background2.jpg'),
                          ),
                        );
                      },
                      child: CharacterImage(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => MainScreen2(backgroundImage: 'assets/background/background3.jpg'),
                          ),
                        );
                      },
                      child: CharacterImage(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => MainScreen2(backgroundImage: 'assets/coming_soon.png'),
                          ),
                        );
                      },
                      child: CharacterImage(
      ...
      child: GestureDetector(
        onTap: () {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => MainScreen(characterImage: imagePath),
            ),
          );
        },
        child: Image.asset(
